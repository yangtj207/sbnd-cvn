...
class DataGenerator(object):
    ...
    def __data_generation(self, labels, list_IDs_temp, yield_labels):
        ...
        for i, ID in enumerate(list_IDs_temp):
            ...
            with open(self.images_path + '/' + ID + '.gz', 'rb') as image_file:
            ...
            if yield_labels:
                ...
                with open(self.images_path + '/' + ID + '.info', 'rb') as info_file:
                    ...
                    self.test_values.append({'y_value':y_value,
                                             ...
                                             'fEventWeight': float(energy_values[6]),
                                             'ID' : ID})
    ...
    def normalize(self, value, obj):
        #print("type of the object : ", type(obj), " size of the array : ", obj.shape)
        #print("value : ", value, " object size : ", obj.size)
    ...
    def sparsify7(self, y):
        ...
        for i in range(1,len(res)): # flavour, interaction, fNProton, fNPion, fNPizero, fNNeutron
            res[i] = np.zeros((y.shape[0], 4), dtype=int) # change 4 to 5 here     
