...
count_flavour = [0]*5 # [0]*5
count_category = [0]*15 # [0]*15
...
for images_path in glob.iglob(IMAGES_PATH + '/*/training'): # IMAGES_PATH + '/*/training'
    ...
    for imagefile in files:
        ...
        ID = imagefile.split("/")[-3] + "/" + imagefile.split("/")[-2] + "/" + file_ID ##### USE THIS ONE
        #ID = file_ID
        #print infofile
        ...
        #'''   
	# special case: cosmic    
        if fInt == 14: ## earlier 14
            fNuPDG = -1 ## earlier -2
            flavour = 2 ## earlier 4
            interaction = -1 ## earlier -2
        ...
        with open(imagefile, 'rb') as image_file:
            file_size = os.stat(imagefile) ## added by varuna
            if file_size.st_size == 0: # added by varuna
               print(imagefile, " : ", file_size.st_size) # added by varuna
               continue # added by varuna
            try: 
            ...
            #file_size = os.stat(imagefile)
            #if file_size.st_size == 0: print(imagefile, " : ", file_size.st_size)
            ...
            if count_less_10nonzero > 0:
                ...
                continue ## Uncomment this when your are running original training
